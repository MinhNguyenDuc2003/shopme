...
public class SettingController {
	...
	public String listAll(Model model) {
		List<Setting> listSettings = service.listAllBySettings();
	...
	public String saveMailTemplateSettings(HttpServletRequest request, RedirectAttributes ra) throws IOException {
		List<Setting> mailTempalteSettings = service.getMailTemplateSettings();
		updateSettingValuesFromForm(request, mailTempalteSettings);
